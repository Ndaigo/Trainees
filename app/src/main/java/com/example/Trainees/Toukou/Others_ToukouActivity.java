...
public class Others_ToukouActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private static final String TAG = "Others_ToukouActivity";
    public String myuid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_others_toukou);
        ...
        DocumentReference docRef = db.collection("Toukou").document(ToukouID);
        ...
        docRef.collection("Comment").orderBy("time")
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(Others_ToukouActivity.this, "Error Getting task list.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        backBt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                /*else if(Activity.equals("Otherspage")){
                    Intent intent = new Intent(getApplication(), Others_pageActivity.class);
                    intent.putExtra("UserID",uid);
                    startActivity(intent);
                }*/
        ...
        reloadBT.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(getApplication(), Others_ToukouActivity.class);
                intent.putExtra("ToukouID",ToukouID);
